            ...
            {!isLoading && activeTab === "document" ? (
              <>
                <section className="settings-card">
                  ...
                  <div className="settings-split-summary"><strong>{documentSettings.minimumLength}–{documentSettings.maximumSplitLength}</strong><span>字符 / 逻辑块</span><p>较小的分块定位更精确；较大的分块能保留更完整的章节上下文。</p></div>
