...
def get_public_runtime_config() -> dict[str, Any]:
    ...
    return {
        ...
        "research": {
            ...
            "modelMaxConcurrency": settings.agent_model_max_concurrency,
            "semanticMaxContextChars": settings.research_semantic_max_context_chars,
            "semanticMaxOutputTokens": settings.research_semantic_max_output_tokens,
